...
namespace VojsaceCinema.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EnrollId,StudentId,CourseId,StudentYear")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnrollId,StudentId,CourseId,StudentYear")] Enrollment enrollment)
        {
            if (id != enrollment.EnrollId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!EnrollmentExists(enrollment.EnrollId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Enrollments.Any(e => e.EnrollId == id);
        }
    }
}
